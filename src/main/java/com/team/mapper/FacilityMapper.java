...
public interface FacilityMapper {
     ...
     * 查找所有设施
     */
    @Select("SELECT name, capacity as holdpeople, count(name) as groundnumber, title as Ad_title, description as Ad_describtion, startTime as starttime, endTime as endtime FROM facility group by name")
     ...
     * 添加设施
     */
    @Insert("INSERT INTO facility (name, capacity, description, title) " +
            " VALUES ( #{name}, #{capacity}, #{description}, #{title})")
